...
class ArticleController {
    ...
    public function show($id) {
        ...
        $comments = $this->commentRatingModel->getCommentsByItem($id, 'article', true); // Only get pure comments
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $parentCommentId = filter_var($_POST['parent_comment_id'] ?? null, FILTER_VALIDATE_INT); // For replies
