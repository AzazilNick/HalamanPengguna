    ...
    public function detail($itemType, $itemId) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($action === 'submit_comment') {
                ...
                // If filter_var returns false (meaning not a valid int or empty), set it to null
                ...
                if (empty($commentText)) {
                    ...
                    if ($this->commentRatingModel->addEntry($itemId, $itemType, $currentUserId, $commentText, $parentCommentId, null)) {
        ...
        // Re-fetch comments after potential submission to display the new one
