    ...
    public function getAllFilms() {
        $stmt = $this->pdo->prepare("
            SELECT
                ...
                SUM(CASE WHEN cr.item_type = 'film' AND cr.rating_value IS NOT NULL THEN 1 ELSE 0 END) AS total_new_ratings,
                SUM(CASE WHEN cr.item_type = 'film' AND cr.rating_value IS NULL THEN 1 ELSE 0 END) AS total_comments,
