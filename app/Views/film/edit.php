        ...
        <?php if ($film): ?>
            <form id="editFilmForm" action="<?= $basePath ?>/daftar_film/edit/<?= escape_html($film['id']) ?>" method="POST">
                <div class="input-group">
                    ...
                    <input type="text" id="title" name="title" required value="<?= escape_html($_POST['title'] ?? $film['title']) ?>" data-field="title">
                ...
                <div class="input-group">
                    ...
                    <textarea id="description" name="description" rows="10" required data-field="description"><?= escape_html($_POST['description'] ?? $film['description']) ?></textarea> 
                    <span class="validation-message error" id="description-error"> <?php if (isset($error['description'])): ?>
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="release_year" name="release_year" required value="<?= escape_html($_POST['release_year'] ?? $film['release_year']) ?>" data-field="release_year"> 
                    <span class="validation-message error" id="release_year-error"> <?php if (isset($error['release_year'])): ?>
                ...
                <div class="input-group">
                    ...
                    <?php if ($filmImageUrl): ?>
                        ...
                        <br>
                    <?php endif; ?>
                    <input type="text" id="image_url" name="image_url" placeholder="http://example.com/image.jpg" value="<?= escape_html($_POST['image_url'] ?? $filmImageUrl) ?>" data-field="image_url"> 
                    <span class="validation-message error" id="image_url-error"> <?php if (isset($error['image_url'])): ?>
