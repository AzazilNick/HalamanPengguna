                ...
                <div class="film-list article-list">
                    <?php foreach ($films as $film): ?>
                        <div class="film-item article-item">
                            ...
                            <p class="film-meta">Jumlah Rating: <?= escape_html($film['total_new_ratings']) ?></p>
                            <p class="film-meta">Jumlah Komentar: <?= escape_html($film['total_comments']) ?></p>
                ...
                <div class="series-list">
                    <?php foreach ($series as $s): ?>
                        <div class="series-item">
                            ...
                            <p class="series-meta">Jumlah Rating: <?= escape_html($s['total_new_ratings']) ?></p>
                            <p class="series-meta">Jumlah Komentar: <?= escape_html($s['total_comments']) ?></p>
