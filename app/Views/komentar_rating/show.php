...
<main>
    <div class="article-detail-container">
        ...
        <article class="single-article">
            ...
            <p class="<?= $itemType ?>-meta">Rating Rata-rata: <strong><?= number_format($item['average_rating'], 1) ?>/10</strong> (dari <?= escape_html($item['total_new_ratings']) ?> ulasan)</p> <p class="<?= $itemType ?>-meta">Total Suka: <strong><?= escape_html($item['total_likes']) ?></strong></p>
