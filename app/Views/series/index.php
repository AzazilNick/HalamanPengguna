                    ...
                    <?php foreach ($popularSeries as $s): ?>
                        <div class="slider-item">
                            ...
                            <div class="slider-stats">
                                <!-- <span class="stat-item"><i class='bx bxs-heart'></i> <?php // escape_html($s['likes_count']) ?></span>
                                <span class="stat-item"><i class='bx bxs-check-circle'></i> <?php //escape_html($s['watched_count']) ?></span>
                                <span class="stat-item"><i class='bx bxs-message-dots'></i> <?php //escape_html($s['comments_count']) ?></span> -->
                                <span class="stat-item"><i class='bx bxs-heart'></i> <?= 88 ?></span>
                                <span class="stat-item"><i class='bx bxs-check-circle'></i> <?= 86 ?></span>
                                <span class="stat-item"><i class='bx bxs-message-dots'></i> <?= 100 ?></span>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                ...
                <?php foreach ($allSeries as $s): ?>
                        <div class="series-item">
                            ...
                            <div class="series-stats">
                                <span class="stat-item"><i class='bx bxs-heart'></i> <?= 40?></span>
                                <span class="stat-item"><i class='bx bxs-check-circle'></i> <?= 30 ?></span>
                                <span class="stat-item"><i class='bx bxs-message-dots'></i> <?= 21 ?></span>
                            </div>
                        </div>
                <?php endforeach; ?>
            </div>
