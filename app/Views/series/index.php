...
<main>
    <div class="series-container articles-container"> <h1><?= escape_html($title) ?></h1>
        ...
        <?php if (!empty($series)): ?>
            <div class="series-list article-list"> <?php foreach ($series as $s): ?>
                <div class="series-item article-item"> <h2><a href="<?= $basePath ?>/daftar_series/show/<?= escape_html($s['id']) ?>"><?= escape_html($s['title']) ?></a></h2>
