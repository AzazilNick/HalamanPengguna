...
// APP_ROOT sekarang adalah direktori saat ini
define('APP_ROOT', __DIR__); //

// PUBLIC_PATH sekarang adalah direktori saat ini juga, karena index.php ada di root public
...
// basepath sekarang adalah direktori proyek langsung
        ...
        switch ($uriSegments[0]) {
            ...
            case 'comment':
                ...
                if (!empty($uriSegments[0]) && $uriSegments[0] === 'delete' && !empty($uriSegments[1])) {
                    ...
                    array_shift($uriSegments);
                    $commentIdToDelete = array_shift($uriSegments);
                    $params = [$commentIdToDelete];
                    $routeHandled = true;
                } else {
