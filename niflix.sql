...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jun 2025 pada 04.44
...
--
-- Struktur dari tabel `comments_rating`
--
...
--
-- Dumping data untuk tabel `comments_rating`
--
...
(2, 'The Godfather', 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.', 'https://m.media-amazon.com/images/M/MV5BNGEwYjgwOGQtYjg5ZS00Njc1LTk2ZGEtM2QwZWQ2NjdhZTE5XkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg', 1972, '2025-06-15 09:02:58', '2025-06-15 15:46:54', 0, 3),
...
--
-- Struktur dari tabel `review_films`
--
...
--
-- Dumping data untuk tabel `review_films`
--
...
--
-- Struktur dari tabel `review_series`
--
...
--
-- Dumping data untuk tabel `review_series`
--
...
(3, 'admin', 'admin@niflix.com', '$2y$10$QFx.SAgJZD6EX.Mi0Ds8iOWZsbMd1j/39dnjLs8sLSP9TU7BqiXfm', 'Admin Niflix', 'user_3_1749885742.png', 1),
...
--
-- Indeks untuk tabel `comments_rating`
--
...
--
-- Indeks untuk tabel `review_films`
--
...
--
-- Indeks untuk tabel `review_series`
--
...
--
-- AUTO_INCREMENT untuk tabel `comments_rating`
--
ALTER TABLE `comments_rating`
...
--
-- AUTO_INCREMENT untuk tabel `review_films`
--
ALTER TABLE `review_films`
...
--
-- Ketidakleluasaan untuk tabel `comments_rating`
--
ALTER TABLE `comments_rating`
