        ...
        <?php if ($series): ?>
            <form id="editSeriesForm" action="<?= $basePath ?>/daftar_series/edit/<?= escape_html($series['id']) ?>" method="POST">
                <div class="input-group">
                    ...
                    <input type="text" id="title" name="title" required value="<?= escape_html($_POST['title'] ?? $series['title']) ?>">
                ...
                <div class="input-group">
                    ...
                    <textarea id="description" name="description" rows="10" required><?= escape_html($_POST['description'] ?? $series['description']) ?></textarea>
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="release_year" name="release_year" required value="<?= escape_html($_POST['release_year'] ?? $series['release_year']) ?>">
                ...
                <div class="input-group">
                    ...
                    <?php if ($seriesImageUrl): ?>
                        ...
                        <br>
                    <?php endif; ?>
                    <input type="text" id="image_url" name="image_url" placeholder="http://example.com/image.jpg" value="<?= escape_html($_POST['image_url'] ?? $seriesImageUrl) ?>">
                ...
                <div class="input-group">
                    ...
                    <select id="is_popular" name="is_popular">
                        <option value="0" <?= (isset($_POST['is_popular']) ? $_POST['is_popular'] == 0 : $series['is_popular'] == 0) ? 'selected' : '' ?>>Tidak</option>
                        <option value="1" <?= (isset($_POST['is_popular']) ? $_POST['is_popular'] == 1 : $series['is_popular'] == 1) ? 'selected' : '' ?>>Ya</option>
                    </select>
                </div>
